...
class ModelCatalogProduct extends Model {
	...
	public function addProduct($data)
    {
        ...
        if (isset($data['product_analog'])) {
            foreach ($data['product_analog'] as $product_analog) {
                $this->db->query("DELETE FROM " . DB_PREFIX . "product_analog WHERE product_id = '" . (int)$product_id . "' AND analog_id = '" . (int)$product_analog . "'");
                $this->db->query("INSERT INTO " . DB_PREFIX . "product_analog SET product_id = '" . (int)$product_id . "', analog_id = '" . (int)$product_analog . "'");
                $this->db->query("DELETE FROM " . DB_PREFIX . "product_analog WHERE product_id = '" . (int)$product_id . "' AND analog_id = '" . (int)$product_analog . "'");
                $this->db->query("INSERT INTO " . DB_PREFIX . "product_analog SET product_id = '" . (int)$product_id . "', analog_id = '" . (int)$product_analog . "'");
            }
        }
     ...
     * @return mixed
     */
    public function getProductsByUUID($uuid)
    {
