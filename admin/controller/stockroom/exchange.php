...
class ControllerStockroomExchange extends Controller
{
    ...
    public function index()
    {
        ...
        $data['getStockroom'] = $this->url->link('stockroom/exchange/getStockroom', 'user_token=' . $this->session->data['user_token']);
    ...
    public function getStockroom()
    {
        ...
        $this->response->redirect($this->url->link('stockroom/stockroom', 'user_token=' . $this->session->data['user_token'], true));
    }
}