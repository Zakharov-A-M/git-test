...
class ControllerStockroomNomenclature extends Controller
{
    ...
    protected function getList()
    {
        if (!isset($this->request->get['stockroom_id']) || empty($this->request->get['stockroom_id'])) {
            $this->response->redirect($this->url->link('stockroom/stockroom', 'user_token=' . $this->session->data['user_token']));
        }
        ...
        $data['add'] = $this->url->link('stockroom/nomenclature/add', 'user_token=' . $this->session->data['user_token'] . $url . '&stockroom_id='. $stockroom_id .'');
        $data['delete'] = $this->url->link('stockroom/nomenclature/delete', 'user_token=' . $this->session->data['user_token'] . $url . '&stockroom_id='. $stockroom_id .'');

        $data['nomenclature'] = array();
        ...
        $stockroom_total = $this->model_stockroom_nomenclature->getTotalNomenclatures($stockroom_id);

        $results = $this->model_stockroom_nomenclature->getNomenclatures($stockroom_id, $filter_data);

        $this->document->setTitle($this->language->get('heading_title') . ' ' . $this->model_stockroom_stockroom->getStockroomName($stockroom_id));

        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title').' '.$this->model_stockroom_stockroom->getStockroomName($stockroom_id),
            'href' => $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url . '&stockroom_id='. $stockroom_id .'')
        );
        ...
        foreach ($results as $result) {
            ...
            $data['nomenclatures'][] = array(
                ...
                'edit'            => $this->url->link('stockroom/nomenclature/edit', 'user_token=' . $this->session->data['user_token'] . '&id=' . $result['id'] . $url .  '&stockroom_id='. $stockroom_id .''),
                'delete'          => $this->url->link('stockroom/nomenclature/delete', 'user_token=' . $this->session->data['user_token'] . '&id=' . $result['id'] . '&stockroom_id=' . $stockroom_id .' '.$url),
            );
        }
        ...
        $data['sort_sort_amount'] = $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . '&sort=amount' . '&stockroom_id=' . $stockroom_id . $url);
        $data['sort_sort_description'] = $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . '&sort=description' . '&stockroom_id=' . $stockroom_id . $url);
        $data['sort_sort_name'] = $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . '&stockroom_id=' . $stockroom_id . $url);
        ...
        $pagination->url = $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}');
    ...
    public function delete()
    {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            ...
            $this->response->redirect($this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url));
        }
        $this->getList();
    }
    ...
    public function edit()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url .  '&stockroom_id='. $this->request->get['stockroom_id'] .''));
        }
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['id'])) {
            $data['action'] = $this->url->link('stockroom/nomenclature/add', 'user_token=' . $this->session->data['user_token'] . $url .  '&stockroom_id='. $stockroom_id .'');
        } else {
            $data['action'] = $this->url->link('stockroom/nomenclature/edit', 'user_token=' . $this->session->data['user_token'] . '&id=' . $this->request->get['id'] . $url .  '&stockroom_id='. $stockroom_id .'');
        }

        $data['cancel'] = $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url .  '&stockroom_id='. $this->request->get['stockroom_id'] .'');
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title').' '. $this->model_stockroom_nomenclature->getNomenclatures($stockroom_id, [])[0]['name_stockroom'],
            'href' => $this->url->link('stockroom/nomenclature', 'user_token=' . $this->session->data['user_token'] . $url . '&stockroom_id='. $stockroom_id .'')
        );
    ...
    {
        if (!empty($this->request->post['nomenclature_id'] || isset($this->request->post['nomenclature_id']))) {
            if ($this->model_stockroom_nomenclature->dublicateNomenclature($this->request->get['stockroom_id'], $this->request->post) > 0) {
    ...
    public function autocomplete()
    {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_stockroom_nomenclature->getNomenclatureForAutocomplete($filter_data);
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            if ($this->noDublicate()) {
                ...
                $this->model_stockroom_nomenclature->addNomenclature($this->request->get['stockroom_id'], $this->request->post);
