...
class ControllerCatalogNews extends Controller {
	...
	public function index()
    {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->response->redirect($this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'], true));
	...
	private function getList()
    {
		...
		$data['add'] = $this->url->link('catalog/news/add', 'user_token=' . $this->session->data['user_token'], true);
		$data['delete'] = $this->url->link('catalog/news/delete', 'user_token=' . $this->session->data['user_token'], true);
		$data['setting'] = $this->url->link('catalog/news/setting', 'user_token=' . $this->session->data['user_token'], true);
    	...
    	foreach ($results as $result) {
			...
			$data['news'][] = array(
				...
				'edit'      	=> $this->url->link('catalog/news/edit', 'user_token=' . $this->session->data['user_token'] . '&news_id=' . $result['news_id'], true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'] . '&sort=nd.title' . $url, true);
		$data['sort_date_added'] = $this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'] . '&sort=n.date_added' . $url, true);
	...
	private function getForm()
    {
		...
		if (!isset($this->request->get['news_id'])) {
			$data['action'] = $this->url->link('catalog/news/add', 'user_token=' . $this->session->data['user_token'], true);
		} else {
			$data['action'] = $this->url->link('catalog/news/edit', 'user_token=' . $this->session->data['user_token'] . '&news_id=' . $this->request->get['news_id'], true);
		}
	
		$data['cancel'] = $this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function setting()
    {
		...
		$data['action'] = $this->url->link('catalog/news/setting', 'user_token=' . $this->session->data['user_token'], true);
		$data['cancel'] = $this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('catalog/news/setting', 'user_token=' . $this->session->data['user_token'], true),
