...
class ModelCatalogProduct extends Model {
    ...
    public function findProductGUID($guid)
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "product where GUID='" . $guid ."'";
    ...
    {
        if (!$this->findProductGUID($data['GUID'])) {
